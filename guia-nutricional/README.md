# 🍽️ Mi Guía Nutricional

App web para planificar tus comidas semanales según tus características personales, basada en las 4 dietas con más respaldo científico: **Mediterránea, DASH, Flexitariana y MIND**.
...
Sin instalación ni dependencias: abre `index.html` en el navegador. También puede servirse con GitHub Pages apuntando a esta carpeta.

## Documentación

La investigación completa (esferas de alimentos, inventario por dieta, técnicas de cocción, aderezos maestros, rankings por frecuencia, enfermedad y edad) está en [`ALIMENTOS.md`](./ALIMENTOS.md).

> ⚠️ Esta app es orientativa y no sustituye el consejo de un médico o dietista-nutricionista.
